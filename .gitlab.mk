...
perf_clone_benchs_repo:
	...
	cd bench-run && git checkout opiskunov/add-bench-report
...
perf_run:
	cd /opt/bench-run && git fetch --all && git checkout opiskunov/add-bench-report && git status && git show && git remote show origin
